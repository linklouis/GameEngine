...
public class VectorCollider2D extends Collider2D<VectorCollider2D> {
    ...
    public VectorCollider2D() {
        super();
    }

    public VectorCollider2D(Modifier... modifiers) {
        super(modifiers);
    }
    ...
    @Override
    public boolean isColliding(VectorCollider2D coll) {
        return false; //TODO
    }
    ...
    @Override
    public Class<VectorCollider2D> getColliderClass() {
        return null;
    }
