...
import gameengine.threed.graphics.objectgraphics.textures.BaseTexture;
...
import gameengine.threed.graphics.objectgraphics.textures.SubsurfaceTexture;
    ...
    private void evenSpheresAndTris(double reflectivity) {
        ...
        for (RayTraceable visual : getGraphicsDriver().getVisualObjects()) {
            if (visual instanceof Tri) {
                numTris++;
            } else if (visual instanceof Sphere) {
                numSpheres++;
            }
        }
